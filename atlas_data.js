...
const SC_FRAC = [
    ...
    [0.00, 0.00],  // Scene 1: zoom to entry point (no 3I yet)
    [0.00, 0.00],  // Scene 2: 3I/ATLAS flies into frame (hard-coded start position)
    [0.00, 0.35],  // Scene 3: spot 3I/ATLAS continues (Jul 1 - Sep 30)
    [0.35, 0.41],  // Scene 4: entering system POV (Oct 1 - Oct 28)
    [0.37, 0.52],  // Scene 5: Mars flyby + Perihelion (Oct 3 - Nov 30)
    [0.52, 0.70],  // Scene 6: outbound, Earth alignment (Dec 1 - Jan 31)
    [0.70, 1.00],  // Scene 7: Jupiter flyby, exit (Feb 1 - Mar 16)
];
